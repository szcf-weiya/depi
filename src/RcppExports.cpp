...
RcppExport SEXP _depi_DetectEpi(SEXP inputfile_XSEXP, SEXP inputfile_YSEXP, SEXP inputfile_COVSEXP, SEXP IS_EXIST_COVSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(DetectEpi(inputfile_X, inputfile_Y, inputfile_COV, IS_EXIST_COV));
...
static const R_CallMethodDef CallEntries[] = {
    {"_depi_DetectEpi", (DL_FUNC) &_depi_DetectEpi, 4},
